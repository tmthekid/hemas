...
@section('content')
    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        @if(request()->session()->get('code') != '')
            <div style="background: rgba(255, 255, 255); padding: 3rem; border-radius: 1rem; margin-bottom: 2rem;">
        ...
        @else
            <div style="background: rgba(255, 255, 255); padding: 3rem; border-radius: 1rem; margin-bottom: 2rem;">Sorry, you didn't win, try again.</div>
